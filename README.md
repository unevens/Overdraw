...
- Customizable smoothing time, used to avoid zips when automating the knots of the splines, the wet amount, the smoothing time, and the the input and output gains.
